...
\begin{table}[ht!]
	...
	\begin{tabular}{r l|l p{12cm} }
		...
		\textcolor{gray}{Função no projeto} &&& {O encode será utilizado para medir a posição angular do gancho da garra pescadora. Auxiliando assim a visualização do processo de acoplagem entre a garra pescadora e o stoplog.   } \\
